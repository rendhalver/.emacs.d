...
* Static site/blog generation
  ...
  #+BEGIN_SRC emacs-lisp
    (use-package org-page
      ...
      :ensure t
      :config
      (setq op/repository-directory "~/Projects/Rendhalver/rendhalver.github.io")
      (setq op/site-domain "https://rendhalver.github.io")
      (setq op/personal-github-link "https://github.com/rendhalver")
      (setq op/site-main-title "Pete Brown")
 ...
 * puppet-mode
  ...
  We use Puppet a lot.
  This loads up the packages required to edit puppet code nicely
